...
$dynamoSearchQuery = $dynamoClient->scan(array(
    ...
    'FilterExpression' => 'contains(tagsLowercase, :searchQuery) OR contains(titleLowercase, :searchQuery) OR contains(descriptionLowercase, :searchQuery)',
...
<div class="search-results-page">
    <div class="container">
<h1 style="margin-top:2rem">Search Results for "<?php echo $searchQuery; ?>"</h1>
